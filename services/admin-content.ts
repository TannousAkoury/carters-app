...
export type AdminSection = { id: string; type: "hero" | "text" | "products" | "announcement"; title: string; subtitle: string; image: string; buttonLabel: string; background: string; enabled: boolean; placement?: AdminPlacement };
