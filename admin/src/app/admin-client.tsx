...
type View = "dashboard" | "editor" | "inventory" | "promotions" | "analytics" | "marketing" | "loyalty" | "orders" | "customers" | "chat" | "team" | "settings";
    ...
    <div className={styles.shell}>
      <aside className={styles.sidebar}>
        ...
        <nav className={styles.nav}>
          ...
          <Nav active={view === "loyalty"} onClick={() => setView("loyalty")} icon="★" label="Loyalty" />
