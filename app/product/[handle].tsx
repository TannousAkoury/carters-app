import { createCheckout, getProduct, ProductDetails, ProductVariant } from "@/services/shopify";
...
const styles = StyleSheet.create({
  ...
  description: { color: "#657083", lineHeight: 22, margin: 18, marginTop: 24 }, error: { color: "#c5524a", textAlign: "center", margin: 16 }, footer: { padding: 14, borderTopWidth: 1, borderTopColor: "#eee" }, buy: { height: 54, borderRadius: 6, backgroundColor: "#174f86", alignItems: "center", justifyContent: "center" }, buyDisabled: { opacity: 0.5 }, buyText: { color: "#fff", fontSize: 16, fontWeight: "900" },
});
