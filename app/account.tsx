...
const ACCOUNT_SECTIONS: { id: AccountSection; label: string; icon: keyof typeof Ionicons.glyphMap }[] = [
  { id: 'profile', label: 'Profile', icon: 'person-outline' },
  { id: 'rewards', label: 'Rewards', icon: 'sparkles-outline' },
      ...
      <ScrollView contentContainerStyle={styles.container} keyboardShouldPersistTaps="handled">
        {customer ? <>
          ...
          {section === 'addresses' ? <View style={styles.section}>
            <SectionHeader icon="location-outline" title="Saved addresses" copy="Manage delivery details and choose your default address." />
          ...
          {section === 'orders' ? <View style={styles.section}>
            {!selectedOrder ? <SectionHeader icon="receipt-outline" title="Order history" copy="Review your purchases, payment status, and delivery progress." /> : null}
